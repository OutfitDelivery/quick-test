    ...
    <Fragment>
      <Row imageUrl={imageUrl}>
          ...
          <PreviewWrapper isDisabled={isGenerating ? true : false}>
            ...
            {generatedAvatar && (
              <DownloadButton
                component="a"
                target="_blank"
                href={generatedAvatar.square}>
                Download
              </DownloadButton>
            )}
          </PreviewWrapper>
          <TextContainer>
            <Text component={TextVariants.p}>Instagram</Text>
        ...
        <Col>
          ...
          <TextContainer>
            <Text component={TextVariants.p}>Facebook, LinkedIn, Twitter</Text>
            {imageUrl && <GeneratingTag />}
          </TextContainer>
        </Col>
      </Row>
